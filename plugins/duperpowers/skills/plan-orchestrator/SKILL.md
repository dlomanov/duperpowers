...
Example:
```
commit: [ACQ-19372] добавляет тест-дизайн для CreatePayout
commit: [ACQ-19372] реализует тесты CreatePayout
commit: [ACQ-19372] реализует CreatePayout
commit: [ACQ-19372] добавляет тесты для непокрытых веток CreatePayout
```
